        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12 max-w-7xl mx-auto px-4">
                {categories.map((cat) => {
                    ...
                    return (
                        <div key={cat} className="bg-white p-4 rounded-xl flex flex-col items-center justify-center shadow hover:shadow-lg transition">
                            {catProduct && (
                                <img src={catProduct.image} alt={cat} className="w-32 h-32 object-cover rounded-full mb-2" />
                            )}
            ...
            {/* Products Sections with Load More */}
    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {catProducts.slice(0, visible).map((product) => <ProductCard key={product.id} product={product} />)}
            </div>
